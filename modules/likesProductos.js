...
function updateLikesUI() {
  ...
  likedProducts.forEach(product => {
    ...
    productItem.innerHTML = `
      ...
      <div class="btns-likes">
        <button class="add-to-cart-from-likes">Agregar al Carrito</button>
        <button class="remove-from-likes">Eliminar</button>
      </div>
    `;
  ...
  //Agregar eventos a "Agregar al Carrito"
  const agregarBtns = document.querySelectorAll(".add-to-cart-from-likes");
  ...
  //Agregar eventos a "Eliminar"
  const eliminarBtns = document.querySelectorAll(".remove-from-likes");
